...
import com.alicebank.finances.core.exception.AccountConflictException;
import com.alicebank.finances.core.exception.AccountNumberDuplicateException;
...
public class AccountImpl implements AccountGateway {
    ...
    public void save(final Account account) {
        try {
            ...
            throw new AccountNumberDuplicateException(ex);
        }
    }
