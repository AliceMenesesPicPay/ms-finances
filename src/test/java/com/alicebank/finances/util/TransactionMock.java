...
import static com.alicebank.finances.core.domain.AccountStatus.ACTIVATED;
...
public class TransactionMock {
    ...
    public static Transaction createWithAccountIsCanceled(AccountStatus statusFromAccount, AccountStatus statusToAccount) {
        return Transaction.builder()
                .id(ID)
